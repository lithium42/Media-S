...
<div id="container">
	...
	<div id="header" class="col-full">
        ...
        <div id="topsearch" class="fr">
			...
			<fieldset>
				<label><input type="text" class="input" name="s" value="<?php _e('Rechercher...', 'woothemes') ?>" onfocus="if (this.value == '<?php _e('Rechercher...', 'woothemes') ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e('Rechercher...', 'woothemes') ?>';}" /></label>
   				<input type="submit" class="search-logo" name="submit" value="" />
			</fieldset>
	  		</form>
	  	</div><!-- /#topsearch -->		
