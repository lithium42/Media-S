...
function woo_custom_nav_scripts() {
	...
	wp_register_script( 'woo-nav-dynamic', get_bloginfo( 'template_directory').'/functions/js/custom_menu_dynamic_items.js', array( 'jquery-ui-dialog' ));
	wp_enqueue_script( 'woo-nav-dynamic' );
	wp_register_script( 'woo-nav-initial', get_bloginfo( 'template_directory').'/functions/js/custom_menu_initial_items.js', array( 'jquery-ui-dialog' ));
	wp_enqueue_script( 'woo-nav-initial' );
	wp_register_script( 'woo-nav-autocomplete', get_bloginfo( 'template_directory').'/functions/js/jquery.autocomplete.js', array( 'jquery' ));
					...
					elseif ($type == "backend")
					{
						...
						<dl>
							<dt>
								...
								<a id="edit<?php echo $woo_custom_nav_menu_items->position; ?>" onclick="edititem(<?php echo $woo_custom_nav_menu_items->position; ?>)" value="<?php echo $woo_custom_nav_menu_items->position; ?>"><img class="edit" alt="Edit Menu Item" title="Edit Menu Item" src="<?php echo get_bloginfo( 'template_directory' ); ?>/functions/images/ico-edit.png" /></a> 
								...
								<a id="view<?php echo $woo_custom_nav_menu_items->position; ?>" target="_blank" href="<?php echo $link; ?>"><img alt="View Page" title="View Page" src="<?php echo get_bloginfo( 'template_directory' ); ?>/functions/images/ico-viewpage.png" /></a>
								</span>
							</dt>
						</dl>
			...
			?><?php 
						...
						elseif ($output_type == "backend")
						{
							...
							<dt>
								...
								<a id="edit<?php echo $counter; ?>" onclick="edititem(<?php echo $counter; ?>)" value="<?php echo $counter; ?>"><img class="edit" alt="Edit Menu Item" title="Edit Menu Item" src="<?php echo get_bloginfo( 'template_directory' ); ?>/functions/images/ico-edit.png" /></a> 
								...
								<a id="view<?php echo $counter; ?>" target="_blank" href="<?php echo $link; ?>"><img alt="View Page" title="View Page" src="<?php echo get_bloginfo( 'template_directory' ); ?>/functions/images/ico-viewpage.png" /></a>
								</span>
							</dt>
							</dl>
				...
				if ($type == 'menu')
				{
					...
					<li id="menu-<?php echo $intCounter; ?>" value="<?php echo $intCounter; ?>">
						...
						<span class="controls">
							...
							<a id="edit<?php echo $intCounter; ?>" onclick="edititem(<?php echo $intCounter; ?>)" value="<?php echo $intCounter; ?>"><img class="edit" alt="Edit Menu Item" title="Edit Menu Item" src="<?php echo get_bloginfo( 'template_directory' ); ?>/functions/images/ico-edit.png" /></a> 
			...
			if ($cat_item->parent == 0)
			{
			    ...
			    elseif ($type == 'default')
			    {
			    	...
			    	<li>
	        			...
	        			?>
	        			<?php $templatedir = get_bloginfo( 'template_directory' ); ?>
						<span class="title"><?php echo $cat_item->cat_name; ?></span> <a onclick="appendToList( '<?php echo $templatedir; ?>','Category','<?php echo $post_text; ?>','<?php echo $post_url; ?>','<?php echo $post_id; ?>','<?php echo $post_parent_id ?>','<?php echo $description; ?>')" name="<?php echo $post_text; ?>" value="<?php echo $post_url;  ?>"><img alt="Add to Custom Menu" title="Add to Custom Menu"  src="<?php echo get_bloginfo( 'template_directory' ); ?>/functions/images/ico-add.png" /></a> </dt>
						</dl>
						<?php $parentli = $cat_item->cat_ID; ?>
			            <?php $intCounter++; ?>		
						<?php 
		...
		foreach ($sub_array as $sub_item)
		{
			...
			elseif ($output_type == 'default')
			{
				...
				<li>
					...
					<?php $templatedir = get_bloginfo( 'template_directory' ); ?>
					<span class="title"><?php echo $title; ?></span> <a onclick="appendToList( '<?php echo $templatedir; ?>','<?php echo $appendtype; ?>','<?php echo $title; ?>','<?php echo $link; ?>','<?php echo $itemid; ?>','<?php echo $parent_id ?>','<?php echo $description; ?>')" name="<?php echo $title; ?>" value="<?php echo $link; ?>"><img alt="Add to Custom Menu" title="Add to Custom Menu" src="<?php echo get_bloginfo( 'template_directory' ); ?>/functions/images/ico-add.png" /></a> </dt>
					</dl>
					<?php 
